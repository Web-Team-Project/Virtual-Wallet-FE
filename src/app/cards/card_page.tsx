      ...
      <div className="w-full max-w-6xl mx-auto p-4">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold text-white text-center w-full">
            Welcome to Your Card Management
          </h1>
        </div>
        <p className="text-lg text-gray-300 mb-12 text-center">
          Here you can manage all your cards. Create, edit, and delete your
          cards easily.
        </p>
        {cards.length > 0 && (
          <div className="flex flex-row flex-wrap justify-center gap-4 mb-6">
            {cards.map((card) => (
              <BackgroundGradient
                key={card.id}
                className="flex flex-col items-center justify-center rounded-[22px] w-full sm:max-w-xs p-4 sm:p-0.5 bg-white dark:bg-zinc-900 shadow-lg"
        ...
        <div className="relative group">
          ...
          >
            <span className="relative z-10">
              {showCreateForm ? "Hide Form" : "Create New Card"}
            </span>
          </button>
        </div>
        {showCreateForm && (
          <BackgroundGradient className="mt-4 p-4 bg-white dark:bg-zinc-900 rounded-[22px] shadow-lg flex flex-col items-center">
            ...
            <div className="w-full max-w-xs">
              ...
              <select
                ...
                onChange={(e) =>
                  setNewCard({ ...newCard, design: e.target.value })
                }
                className="rounded-full px-4 py-2 text-black dark:text-white bg-gray-200 dark:bg-gray-700 mb-2 w-full"
              >
          ...
          <BackgroundGradient className="mt-4 p-4 bg-white dark:bg-zinc-900 rounded-[22px] shadow-lg flex flex-col items-center">
            ...
            <div className="w-full max-w-xs">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditCard({ ...editCard, card_holder: e.target.value })
                }
                className="rounded-full px-4 py-2 text-black dark:text-white bg-gray-200 dark:bg-gray-700 mb-2 w-full"
              />
              <input
                ...
                onChange={(e) =>
                  setEditCard({ ...editCard, exp_date: e.target.value })
                }
                className="rounded-full px-4 py-2 text-black dark:text-white bg-gray-200 dark:bg-gray-700 mb-2 w-full"
              />
              <input
              ...
              <select
                ...
                onChange={(e) =>
                  setEditCard({ ...editCard, design: e.target.value })
                }
                className="rounded-full px-4 py-2 text-black dark:text-white bg-gray-200 dark:bg-gray-700 mb-2 w-full"
              >
                <option value="credit">Credit</option>
